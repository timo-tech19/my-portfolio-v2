      ...
      <div className="flex">
        <div className="mb-2 w-1/2">
          <p className="pr-8 leading-relaxed">
            ...
            with an eye for{' '}
            <span className="font-bold text-primary">beautiful UI design</span>.
            I currently work at FieldR as a Mobile Developer. I also have
            experience working with the{' '}
            <span className="font-bold text-primary">back-end development</span>
            ...
            years ago. Here are a few famous technologies I picked up along the
            way:
          </p>
